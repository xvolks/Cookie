...
using Cookie.Protocol.Network.Messages.Game.Context.Fight;
...
namespace Cookie.Handlers.Game.Context.Fight
{
    public class GameContextFightHandlers
    {
        ...
        {
            client.Logger.Log("Nombre de tours avant la prochaine vague : " + message.NbTurnBeforeNextWave, LogMessageType.FightLog);           
        }
        ...
        private void GameFightPlacementPossiblePositionsMessageHandler(DofusClient client, GameFightPlacementPossiblePositionsMessage message)
        {
            //
        }
        [MessageHandler(GameFightPlacementSwapPositionsCancelledMessage.ProtocolId)]
        private void GameFightPlacementSwapPositionsCancelledMessageHandler(DofusClient client, GameFightPlacementSwapPositionsCancelledMessage message)
        {
            //
        }
        [MessageHandler(GameFightPlacementSwapPositionsErrorMessage.ProtocolId)]
        private void GameFightPlacementSwapPositionsErrorMessageHandler(DofusClient client, GameFightPlacementSwapPositionsErrorMessage message)
        {
            //
        }
        [MessageHandler(GameFightPlacementSwapPositionsMessage.ProtocolId)]
        private void GameFightPlacementSwapPositionsMessageHandler(DofusClient client, GameFightPlacementSwapPositionsMessage message)
        {
            //
        }
        [MessageHandler(GameFightPlacementSwapPositionsOfferMessage.ProtocolId)]
        private void GameFightPlacementSwapPositionsOfferMessageHandler(DofusClient client, GameFightPlacementSwapPositionsOfferMessage message)
        {
            //
        }     
        [MessageHandler(GameFightRemoveTeamMemberMessage.ProtocolId)]
        private void GameFightRemoveTeamMemberMessageHandler(DofusClient client, GameFightRemoveTeamMemberMessage message)
        {
            //
        }
        ...
        private void GameFightResumeWithSlavesMessageHandler(DofusClient client, GameFightResumeWithSlavesMessage message)
        {
            //
        }
        ...
        private void GameFightSpectatePlayerRequestMessageHandler(DofusClient client, GameFightSpectatePlayerRequestMessage message)
        {
        ...
        private void GameFightTurnReadyRequestMessageHandler(DofusClient client, GameFightTurnReadyRequestMessage message)
        {
        ...
        private void GameFightTurnStartPlayingMessageHandler(DofusClient client, GameFightTurnStartPlayingMessage message)
        {
            //
        }
