...
namespace Cookie.Handlers.Game.Context
{
    ...
    {
        [MessageHandler(GameCautiousMapMovementMessage.ProtocolId)]
        private void GameCautiousMapMovementMessageHandler(DofusClient client, GameCautiousMapMovementMessage message)
        {
            //
        }
