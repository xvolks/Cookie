...
namespace Cookie.Game.World.Pathfinding
{
    public static class PathingUtils
    {
        ...
        private static readonly Point[] CellsPositions = new Point[MapCellsCount];
        ...
        static PathingUtils()
        {
            int _loc_2, _loc_3;
            int _loc_5;
            var _loc_1 = _loc_2 = _loc_3 = _loc_5 = 0;
        ...
        {
            var compressedPath = new List<short>();
            if (path.Count < 2)
            {
        ...
        {
            return (uint) Math.Sqrt((point1.X - point2.X) * (point1.X - point2.X) +
