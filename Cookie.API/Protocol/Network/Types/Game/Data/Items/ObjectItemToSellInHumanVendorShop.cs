...
namespace Cookie.API.Protocol.Network.Types.Game.Data.Items
{
    ...
    public class ObjectItemToSellInHumanVendorShop : Item
    {
        ...
        private ulong m_publicPrice;
        
        public virtual ulong PublicPrice
        {
            get
            {
        ...
        public ObjectItemToSellInHumanVendorShop(List<ObjectEffect> effects, ushort objectGID, uint objectUID, uint quantity, ulong objectPrice, ulong publicPrice)
        {
            m_effects = effects;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            writer.WriteVarUhLong(m_publicPrice);
        }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            m_publicPrice = reader.ReadVarUhLong();
        }
    }
}
