package com.ankamagames.dofus.datacenter.items.criterion
{
   ...
   public class ArenaSoloRankCriterion extends ItemCriterion implements IDataCenter
   {
      ...
      public function ArenaSoloRankCriterion(param1:String)
      {
         super(param1);
      }
      ...
      override public function get text() : String
      {
         ...
         var _loc2_:String = I18n.getUiText("ui.common.pvpSoloRank");
         var _loc3_:* = ">";
      ...
      {
         var _loc1_:ArenaSoloRankCriterion = new ArenaSoloRankCriterion(this.basicText);
         return _loc1_;
      }
      ...
      override protected function getCriterion() : int
      {
         ...
         var _loc2_:int = _loc1_.arenaRankSoloInfos.rank;
         return _loc2_;
      }
   }
}
