      ...
      public static function create(param1:String) : ItemCriterion
      {
         ...
         switch(_loc3_)
         {
            ...
            case "cw":
               ...
               break;
            case "Kd":
               _loc2_ = new ArenaDuelRankCriterion(param1);
               break;
            case "KD":
               _loc2_ = new ArenaMaxDuelRankCriterion(param1);
               break;
            case "Ks":
               _loc2_ = new ArenaSoloRankCriterion(param1);
               break;
            case "KS":
               _loc2_ = new ArenaMaxSoloRankCriterion(param1);
               break;
            case "Kt":
               _loc2_ = new ArenaTeamRankCriterion(param1);
               break;
            case "KT":
               _loc2_ = new ArenaMaxTeamRankCriterion(param1);
               break;
            case "Oa":
               _loc2_ = new AchievementPointsItemCriterion(param1);
               break;
            case "OA":
               _loc2_ = new AchievementItemCriterion(param1);
               break;
            case "Of":
               _loc2_ = new MountFamilyItemCriterion(param1);
               break;
            case "Os":
            ...
            case "PL":
               ...
               break;
            case "Pl":
               _loc2_ = new PrestigeLevelItemCriterion(param1);
               break;
            case "PN":
