package com.ankamagames.dofus.network.types.game.look
{
   ...
   public class EntityLook implements INetworkType
   {
      ...
      public function deserializeAsyncAs_EntityLook(param1:FuncTree) : void
      {
      ...
      private function _bonesIdFunc(param1:ICustomDataInput) : void
      {
      ...
      private function _skinstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _skinsFunc(param1:ICustomDataInput) : void
      {
      ...
      private function _indexedColorstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _indexedColorsFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:int = param1.readInt();
         this.indexedColors.push(_loc2_);
      }
      
      private function _scalestreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _scalesFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:int = param1.readVarShort();
         this.scales.push(_loc2_);
      }
      
      private function _subentitiestreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _subentitiesFunc(param1:ICustomDataInput) : void
      {
