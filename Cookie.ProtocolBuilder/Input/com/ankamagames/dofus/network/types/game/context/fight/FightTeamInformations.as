package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightTeamInformations extends AbstractFightTeamInformations implements INetworkType
   {
      ...
      public function initFightTeamInformations(param1:uint = 2, param2:Number = 0, param3:int = 0, param4:uint = 0, param5:uint = 0, param6:Vector.<FightTeamMemberInformations> = null) : FightTeamInformations
      {
      ...
      public function deserializeAsyncAs_FightTeamInformations(param1:FuncTree) : void
      {
         super.deserializeAsync(param1);
         this._teamMemberstree = param1.addChild(this._teamMemberstreeFunc);
      }
      
      private function _teamMemberstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _teamMembersFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:FightTeamMemberInformations = ProtocolTypeManager.getInstance(FightTeamMemberInformations,_loc2_);
