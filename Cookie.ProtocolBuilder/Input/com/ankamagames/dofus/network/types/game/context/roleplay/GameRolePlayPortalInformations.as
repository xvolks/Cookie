package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayPortalInformations extends GameRolePlayActorInformations implements INetworkType
   {
      ...
      public function initGameRolePlayPortalInformations(param1:Number = 0, param2:EntityLook = null, param3:EntityDispositionInformations = null, param4:PortalInformation = null) : GameRolePlayPortalInformations
      {
      ...
      public function deserializeAsyncAs_GameRolePlayPortalInformations(param1:FuncTree) : void
      {
         super.deserializeAsync(param1);
         this._portaltree = param1.addChild(this._portaltreeFunc);
      }
      
      private function _portaltreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         this.portal = ProtocolTypeManager.getInstance(PortalInformation,_loc2_);
