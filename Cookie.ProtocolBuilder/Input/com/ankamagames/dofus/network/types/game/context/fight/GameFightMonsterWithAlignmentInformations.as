package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightMonsterWithAlignmentInformations extends GameFightMonsterInformations implements INetworkType
   {
      ...
      public function initGameFightMonsterWithAlignmentInformations(param1:Number = 0, param2:EntityLook = null, param3:EntityDispositionInformations = null, param4:uint = 2, param5:uint = 0, param6:Boolean = false, param7:GameFightMinimalStats = null, param8:Vector.<uint> = null, param9:uint = 0, param10:uint = 0, param11:ActorAlignmentInformations = null) : GameFightMonsterWithAlignmentInformations
      {
      ...
      public function deserializeAsyncAs_GameFightMonsterWithAlignmentInformations(param1:FuncTree) : void
      {
