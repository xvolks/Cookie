package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightAllianceTeamInformations extends FightTeamInformations implements INetworkType
   {
      ...
      public function initFightAllianceTeamInformations(param1:uint = 2, param2:Number = 0, param3:int = 0, param4:uint = 0, param5:uint = 0, param6:Vector.<FightTeamMemberInformations> = null, param7:uint = 0) : FightAllianceTeamInformations
      {
      ...
      public function deserializeAsyncAs_FightAllianceTeamInformations(param1:FuncTree) : void
      {
         super.deserializeAsync(param1);
         param1.addChild(this._relationFunc);
      }
      
      private function _relationFunc(param1:ICustomDataInput) : void
      {
