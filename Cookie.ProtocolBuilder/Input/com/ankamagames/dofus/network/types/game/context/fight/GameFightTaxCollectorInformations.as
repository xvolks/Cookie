package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightTaxCollectorInformations extends GameFightAIInformations implements INetworkType
   {
      ...
      public function initGameFightTaxCollectorInformations(param1:Number = 0, param2:EntityLook = null, param3:EntityDispositionInformations = null, param4:uint = 2, param5:uint = 0, param6:Boolean = false, param7:GameFightMinimalStats = null, param8:Vector.<uint> = null, param9:uint = 0, param10:uint = 0, param11:uint = 0) : GameFightTaxCollectorInformations
      {
      ...
      public function deserializeAsyncAs_GameFightTaxCollectorInformations(param1:FuncTree) : void
      {
