package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTemporarySpellBoostEffect extends FightTemporaryBoostEffect implements INetworkType
   {
      ...
      public function initFightTemporarySpellBoostEffect(param1:uint = 0, param2:Number = 0, param3:int = 0, param4:uint = 1, param5:uint = 0, param6:uint = 0, param7:uint = 0, param8:int = 0, param9:uint = 0) : FightTemporarySpellBoostEffect
      {
      ...
      public function deserializeAsyncAs_FightTemporarySpellBoostEffect(param1:FuncTree) : void
      {
         super.deserializeAsync(param1);
         param1.addChild(this._boostedSpellIdFunc);
      }
      
      private function _boostedSpellIdFunc(param1:ICustomDataInput) : void
      {
