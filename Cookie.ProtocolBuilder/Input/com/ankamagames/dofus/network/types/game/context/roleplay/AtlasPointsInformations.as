package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class AtlasPointsInformations implements INetworkType
   {
      ...
      public function deserializeAsyncAs_AtlasPointsInformations(param1:FuncTree) : void
      {
      ...
      private function _coordsFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:MapCoordinatesExtended = new MapCoordinatesExtended();
