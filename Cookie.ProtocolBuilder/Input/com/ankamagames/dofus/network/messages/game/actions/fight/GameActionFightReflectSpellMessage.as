package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightReflectSpellMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightReflectSpellMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0) : GameActionFightReflectSpellMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightReflectSpellMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightReflectSpellMessage(param1:FuncTree) : void
      {
