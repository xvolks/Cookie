package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightDropCharacterMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightDropCharacterMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:int = 0) : GameActionFightDropCharacterMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightDropCharacterMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightDropCharacterMessage(param1:FuncTree) : void
      {
