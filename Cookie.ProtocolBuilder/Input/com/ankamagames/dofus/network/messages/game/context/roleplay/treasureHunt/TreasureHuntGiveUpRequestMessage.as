package com.ankamagames.dofus.network.messages.game.context.roleplay.treasureHunt
{
   ...
   public class TreasureHuntGiveUpRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         this.deserializeAsyncAs_TreasureHuntGiveUpRequestMessage(param1);
      }
      
      public function deserializeAsyncAs_TreasureHuntGiveUpRequestMessage(param1:FuncTree) : void
      {
