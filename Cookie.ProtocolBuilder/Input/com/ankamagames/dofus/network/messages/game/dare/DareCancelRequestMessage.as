package com.ankamagames.dofus.network.messages.game.dare
{
   ...
   public class DareCancelRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initDareCancelRequestMessage(param1:Number = 0) : DareCancelRequestMessage
      {
         this.dareId = param1;
      ...
      public function serializeAs_DareCancelRequestMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_DareCancelRequestMessage(param1:ICustomDataInput) : void
      {
      ...
      {
         this.deserializeAsyncAs_DareCancelRequestMessage(param1);
      }
      
      public function deserializeAsyncAs_DareCancelRequestMessage(param1:FuncTree) : void
      {
