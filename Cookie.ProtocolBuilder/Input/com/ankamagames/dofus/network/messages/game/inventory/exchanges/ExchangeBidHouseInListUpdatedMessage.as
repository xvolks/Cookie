package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeBidHouseInListUpdatedMessage extends ExchangeBidHouseInListAddedMessage implements INetworkMessage
   {
      ...
      public function initExchangeBidHouseInListUpdatedMessage(param1:int = 0, param2:int = 0, param3:Vector.<ObjectEffect> = null, param4:Vector.<Number> = null) : ExchangeBidHouseInListUpdatedMessage
      {
      ...
      public function deserializeAsyncAs_ExchangeBidHouseInListUpdatedMessage(param1:FuncTree) : void
      {
