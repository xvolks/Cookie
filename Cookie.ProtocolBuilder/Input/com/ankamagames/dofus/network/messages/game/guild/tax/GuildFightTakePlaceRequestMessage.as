package com.ankamagames.dofus.network.messages.game.guild.tax
{
   ...
   public class GuildFightTakePlaceRequestMessage extends GuildFightJoinRequestMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_GuildFightTakePlaceRequestMessage(param1:FuncTree) : void
      {
         super.deserializeAsync(param1);
         param1.addChild(this._replacedCharacterIdFunc);
      }
      
      private function _replacedCharacterIdFunc(param1:ICustomDataInput) : void
      {
