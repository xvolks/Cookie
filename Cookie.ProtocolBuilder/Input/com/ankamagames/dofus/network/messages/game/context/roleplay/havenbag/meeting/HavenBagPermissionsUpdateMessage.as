package com.ankamagames.dofus.network.messages.game.context.roleplay.havenbag.meeting
{
   ...
   public class HavenBagPermissionsUpdateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6713;
      ...
      public function initHavenBagPermissionsUpdateMessage(param1:uint = 0) : HavenBagPermissionsUpdateMessage
      {
      ...
      public function serializeAs_HavenBagPermissionsUpdateMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_HavenBagPermissionsUpdateMessage(param1:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_HavenBagPermissionsUpdateMessage(param1:FuncTree) : void
      {
