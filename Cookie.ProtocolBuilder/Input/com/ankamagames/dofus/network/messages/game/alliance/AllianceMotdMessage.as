package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceMotdMessage extends SocialNoticeMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6685;
      ...
      public function initAllianceMotdMessage(param1:String = "", param2:uint = 0, param3:Number = 0, param4:String = "") : AllianceMotdMessage
      {
      ...
      public function serializeAs_AllianceMotdMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_AllianceMotdMessage(param1:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_AllianceMotdMessage(param1:FuncTree) : void
      {
