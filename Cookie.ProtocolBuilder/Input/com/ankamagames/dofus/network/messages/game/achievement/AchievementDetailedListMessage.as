package com.ankamagames.dofus.network.messages.game.achievement
{
   ...
   public class AchievementDetailedListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_AchievementDetailedListMessage(param1:FuncTree) : void
      {
      ...
      private function _startedAchievementstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _startedAchievementsFunc(param1:ICustomDataInput) : void
      {
      ...
      private function _finishedAchievementstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _finishedAchievementsFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:Achievement = new Achievement();
         _loc2_.deserialize(param1);
