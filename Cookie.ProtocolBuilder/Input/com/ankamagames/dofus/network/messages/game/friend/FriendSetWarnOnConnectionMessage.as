package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendSetWarnOnConnectionMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         this.deserializeAsyncAs_FriendSetWarnOnConnectionMessage(param1);
      }
      
      public function deserializeAsyncAs_FriendSetWarnOnConnectionMessage(param1:FuncTree) : void
      {
