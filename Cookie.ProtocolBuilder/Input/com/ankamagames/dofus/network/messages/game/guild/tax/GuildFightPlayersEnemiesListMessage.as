package com.ankamagames.dofus.network.messages.game.guild.tax
{
   ...
   public class GuildFightPlayersEnemiesListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_GuildFightPlayersEnemiesListMessage(param1:FuncTree) : void
      {
      ...
      private function _playerInfoFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:CharacterMinimalPlusLookInformations = new CharacterMinimalPlusLookInformations();
