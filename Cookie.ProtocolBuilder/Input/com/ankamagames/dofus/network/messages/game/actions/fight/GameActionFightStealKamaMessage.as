package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightStealKamaMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightStealKamaMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0) : GameActionFightStealKamaMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightStealKamaMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightStealKamaMessage(param1:FuncTree) : void
      {
