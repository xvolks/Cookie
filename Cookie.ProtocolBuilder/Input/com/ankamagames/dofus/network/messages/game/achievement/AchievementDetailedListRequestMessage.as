package com.ankamagames.dofus.network.messages.game.achievement
{
   ...
   public class AchievementDetailedListRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_AchievementDetailedListRequestMessage(param1:FuncTree) : void
      {
         param1.addChild(this._categoryIdFunc);
      }
      
      private function _categoryIdFunc(param1:ICustomDataInput) : void
      {
