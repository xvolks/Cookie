package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightThrowCharacterMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightThrowCharacterMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:int = 0) : GameActionFightThrowCharacterMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightThrowCharacterMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightThrowCharacterMessage(param1:FuncTree) : void
      {
