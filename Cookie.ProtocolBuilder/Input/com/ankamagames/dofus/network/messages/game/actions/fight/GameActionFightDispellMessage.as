package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightDispellMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightDispellMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0) : GameActionFightDispellMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightDispellMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightDispellMessage(param1:FuncTree) : void
      {
