package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightTurnEndMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initGameFightTurnEndMessage(param1:Number = 0) : GameFightTurnEndMessage
      {
         this.id = param1;
      ...
      {
         this.deserializeAsyncAs_GameFightTurnEndMessage(param1);
      }
      
      public function deserializeAsyncAs_GameFightTurnEndMessage(param1:FuncTree) : void
      {
