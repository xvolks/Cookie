package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightReflectDamagesMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightReflectDamagesMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0) : GameActionFightReflectDamagesMessage
      {
      ...
      {
         this.deserializeAsyncAs_GameActionFightReflectDamagesMessage(param1);
      }
      
      public function deserializeAsyncAs_GameActionFightReflectDamagesMessage(param1:FuncTree) : void
      {
