package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightTeleportOnSameMapMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightTeleportOnSameMapMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:int = 0) : GameActionFightTeleportOnSameMapMessage
      {
      ...
      public function deserializeAsyncAs_GameActionFightTeleportOnSameMapMessage(param1:FuncTree) : void
      {
