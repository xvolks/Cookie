package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightTriggerEffectMessage extends GameActionFightDispellEffectMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightTriggerEffectMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:uint = 0) : GameActionFightTriggerEffectMessage
      {
      ...
      public function deserializeAsyncAs_GameActionFightTriggerEffectMessage(param1:FuncTree) : void
      {
