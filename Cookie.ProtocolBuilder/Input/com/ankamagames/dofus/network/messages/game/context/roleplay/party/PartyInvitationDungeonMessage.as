package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class PartyInvitationDungeonMessage extends PartyInvitationMessage implements INetworkMessage
   {
      ...
      public function initPartyInvitationDungeonMessage(param1:uint = 0, param2:uint = 0, param3:String = "", param4:uint = 0, param5:Number = 0, param6:String = "", param7:Number = 0, param8:uint = 0) : PartyInvitationDungeonMessage
      {
      ...
      public function deserializeAsyncAs_PartyInvitationDungeonMessage(param1:FuncTree) : void
      {
