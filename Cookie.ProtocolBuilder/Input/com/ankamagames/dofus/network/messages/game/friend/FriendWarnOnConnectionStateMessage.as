package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendWarnOnConnectionStateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         this.deserializeAsyncAs_FriendWarnOnConnectionStateMessage(param1);
      }
      
      public function deserializeAsyncAs_FriendWarnOnConnectionStateMessage(param1:FuncTree) : void
      {
