package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightNoSpellCastMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_GameActionFightNoSpellCastMessage(param1:FuncTree) : void
      {
         param1.addChild(this._spellLevelIdFunc);
      }
      
      private function _spellLevelIdFunc(param1:ICustomDataInput) : void
      {
