package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendWarnOnLevelGainStateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         this.deserializeAsyncAs_FriendWarnOnLevelGainStateMessage(param1);
      }
      
      public function deserializeAsyncAs_FriendWarnOnLevelGainStateMessage(param1:FuncTree) : void
      {
