package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class PartyAbdicateThroneMessage extends AbstractPartyMessage implements INetworkMessage
   {
      ...
      public function initPartyAbdicateThroneMessage(param1:uint = 0, param2:Number = 0) : PartyAbdicateThroneMessage
      {
      ...
      {
         this.deserializeAsyncAs_PartyAbdicateThroneMessage(param1);
      }
      
      public function deserializeAsyncAs_PartyAbdicateThroneMessage(param1:FuncTree) : void
      {
