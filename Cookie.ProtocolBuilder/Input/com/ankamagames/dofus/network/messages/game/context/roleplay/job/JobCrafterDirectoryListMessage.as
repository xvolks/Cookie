package com.ankamagames.dofus.network.messages.game.context.roleplay.job
{
   ...
   public class JobCrafterDirectoryListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_JobCrafterDirectoryListMessage(param1:FuncTree) : void
      {
         this._listEntriestree = param1.addChild(this._listEntriestreeFunc);
      }
      
      private function _listEntriestreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _listEntriesFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:JobCrafterDirectoryListEntry = new JobCrafterDirectoryListEntry();
