package com.ankamagames.dofus.network.messages.game.dare
{
   ...
   public class DareInformationsRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initDareInformationsRequestMessage(param1:Number = 0) : DareInformationsRequestMessage
      {
         this.dareId = param1;
      ...
      public function serializeAs_DareInformationsRequestMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_DareInformationsRequestMessage(param1:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_DareInformationsRequestMessage(param1:FuncTree) : void
      {
