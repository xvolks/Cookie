package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightModifyEffectsDurationMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightModifyEffectsDurationMessage(param1:uint = 0, param2:Number = 0, param3:Number = 0, param4:int = 0) : GameActionFightModifyEffectsDurationMessage
      {
      ...
      public function deserializeAsyncAs_GameActionFightModifyEffectsDurationMessage(param1:FuncTree) : void
      {
