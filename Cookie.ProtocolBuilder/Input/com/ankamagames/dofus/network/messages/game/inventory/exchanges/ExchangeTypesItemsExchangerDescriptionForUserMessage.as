package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeTypesItemsExchangerDescriptionForUserMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_ExchangeTypesItemsExchangerDescriptionForUserMessage(param1:FuncTree) : void
      {
         this._itemTypeDescriptionstree = param1.addChild(this._itemTypeDescriptionstreeFunc);
      }
      
      private function _itemTypeDescriptionstreeFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:uint = param1.readUnsignedShort();
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
      ...
      private function _itemTypeDescriptionsFunc(param1:ICustomDataInput) : void
      {
         var _loc2_:BidExchangerObjectInfo = new BidExchangerObjectInfo();
