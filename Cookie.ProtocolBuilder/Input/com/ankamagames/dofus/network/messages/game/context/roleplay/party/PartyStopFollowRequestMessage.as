package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class PartyStopFollowRequestMessage extends AbstractPartyMessage implements INetworkMessage
   {
      ...
      public function initPartyStopFollowRequestMessage(param1:uint = 0, param2:Number = 0) : PartyStopFollowRequestMessage
      {
      ...
      {
         this.deserializeAsyncAs_PartyStopFollowRequestMessage(param1);
      }
      
      public function deserializeAsyncAs_PartyStopFollowRequestMessage(param1:FuncTree) : void
      {
