package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightTurnReadyRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initGameFightTurnReadyRequestMessage(param1:Number = 0) : GameFightTurnReadyRequestMessage
      {
         this.id = param1;
      ...
      public function deserializeAsyncAs_GameFightTurnReadyRequestMessage(param1:FuncTree) : void
      {
