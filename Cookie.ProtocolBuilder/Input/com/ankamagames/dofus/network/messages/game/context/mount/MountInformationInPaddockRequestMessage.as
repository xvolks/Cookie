package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountInformationInPaddockRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAsyncAs_MountInformationInPaddockRequestMessage(param1:FuncTree) : void
      {
         param1.addChild(this._mapRideIdFunc);
      }
      
      private function _mapRideIdFunc(param1:ICustomDataInput) : void
      {
